    ...
    public override void Define(ITemplateDefinitionContext context)
    {
        context.Add(
            new TemplateDefinition(
                ...
                isLayout: true
            ).WithVirtualFilePath("src/Acme.BookStore.Application/Emails/Templates/Emailing/Layout.tpl", true)
             .WithScribanEngine()
        );
        ...
        context.Add(
            ...
            ).WithVirtualFilePath("src/Acme.BookStore.Application/Emails/Templates/Emailing/Message.tpl", true)
            .WithScribanEngine()
        );
    }
}