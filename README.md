...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 6f58d05d-6b02-45f2-b5ed-320a4834901c
```

> `6f58d05d-6b02-45f2-b5ed-320a4834901c` is the password of the certificate, you can change it to any password you want.
